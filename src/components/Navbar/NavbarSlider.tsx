        ...
        >
                ...
                <div className=" left-0  text-black  mx-auto bg-white  ">
                  {miniRoutes.map((item) => (
                    <Link
                      key={item.route}
                      href={item.route}
                      className={`relative flex items-center pr-6 py-[5px] pl-[24px] text-lg transition-all my-3 duration-300 ${
                        path === item.route
                          ? "poppins-semibold text-white border-l-4 border-primary  bg-gradient-to-r from-primary/90 to-primary/75"
                          : "text-black border-l-4 border-transparent hover:border-primary hover:bg-gradient-to-r hover:from-primary/80 hover:to-primary/65 hover:text-black"
                      }`}
          ...
          <div>
            ...
            <button
              ...
              className={`relative flex items-center h-11 pr-6 py-[10px] pl-[24px] text-lg transition-all duration-300 poppins-semibold hover:bg-gradient-to-r hover:from-[primary]/80 hover:to-[#B80069]/60 to-white text-black border-l-4 ${
